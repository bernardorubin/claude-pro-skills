...
description: >-
  ...
  loop on top. Also invoked by /ship-ticket as its self-review step. Uses judgment
...
run it (the "should we even review this?" gate lives in `/ship-ticket`, which asks
