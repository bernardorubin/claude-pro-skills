...
- **Single plugin**: `claude-pro-skills` — bundles 14 skills (no commands). The `pr-review` skill itself supports three modes: PR review, local diff review, and full-repo audit.
