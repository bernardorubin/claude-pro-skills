...
| `/qa` | "QA this ticket", "verify the ACs", "test this and show me it works" — exercises every AC against the real system, captures evidence, posts a pass/fail/could-not-verify comment to Jira or the PR |
