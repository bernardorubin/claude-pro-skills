...
| `/qa-video` | "record a video of this", "a screenshot won't show this", "video QA" — records the flow (Playwright video, Chrome gif, or macOS screen capture), compresses it under GitHub's 10MB cap with ffmpeg, attaches it to Jira and hands back the PR paste; first run installs ffmpeg and checks the Screen Recording permission |
